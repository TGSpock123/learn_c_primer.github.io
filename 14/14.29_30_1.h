...
void select_func (void (* fp)(struct seat *), struct seat *);
...
void del_passenger (struct seat seats[])
{
  ...
  printf ("Please enter the seat to delete: \n");
  s_gets (input, 3);
...
void runs (struct seat seats[])
{
  ...
  while ((sig = tolower(getchar ())) != 102)
  {
    ...
    {
      case 'a':
        funcs = show_empty_seats_num;
        break;
      case 'b':
        funcs = show_seats_list_num;
        break;
      case 'c':
        funcs = show_seats_list_let;
        break;
      case 'd':
        funcs = assign_cus;
        break;
...
void select_func (void (* fp)(struct seat *), struct seat * seats)
{
  (*fp)(seats);
}
